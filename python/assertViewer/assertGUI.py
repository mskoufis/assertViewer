...
#        self.ui.PyDMImageView.scene.sigMouseClicked.connect(self.clickProcess)
    ...
    def setup_main_tab(self):
        ...
        #frame_cnt_line.textChanged.connect(self.resetPlots)
    ...
    def onClick_updatePlots(self):
        ...
        if noise_checkbox.isChecked() and pedestals_checkbox.isChecked() and cm_checkbox.isChecked():
            self.ui.PyDMWaveformPlot_1.addChannel(y_channel = f'{self._dataReceiver}.ASIC0SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_2.addChannel(y_channel = f'{self._dataReceiver}.ASIC1SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_3.addChannel(y_channel = f'{self._dataReceiver}.ASIC2SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_4.addChannel(y_channel = f'{self._dataReceiver}.ASIC3SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_5.addChannel(y_channel = f'{self._dataReceiver}.ASIC4SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_6.addChannel(y_channel = f'{self._dataReceiver}.ASIC5SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_7.addChannel(y_channel = f'{self._dataReceiver}.ASIC6SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_8.addChannel(y_channel = f'{self._dataReceiver}.ASIC7SigNosPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            ...
            self.ui.PyDMWaveformPlot_1.addChannel(y_channel = f'{self._dataReceiver}.ASIC0SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_2.addChannel(y_channel = f'{self._dataReceiver}.ASIC1SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_3.addChannel(y_channel = f'{self._dataReceiver}.ASIC2SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_4.addChannel(y_channel = f'{self._dataReceiver}.ASIC3SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_5.addChannel(y_channel = f'{self._dataReceiver}.ASIC4SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_6.addChannel(y_channel = f'{self._dataReceiver}.ASIC5SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_7.addChannel(y_channel = f'{self._dataReceiver}.ASIC6SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_8.addChannel(y_channel = f'{self._dataReceiver}.ASIC7SigNos',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
        elif pedestals_checkbox.isChecked() and cm_checkbox.isChecked():
            self.ui.PyDMWaveformPlot_1.addChannel(y_channel = f'{self._dataReceiver}.ASIC0SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_2.addChannel(y_channel = f'{self._dataReceiver}.ASIC1SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_3.addChannel(y_channel = f'{self._dataReceiver}.ASIC2SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_4.addChannel(y_channel = f'{self._dataReceiver}.ASIC3SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_5.addChannel(y_channel = f'{self._dataReceiver}.ASIC4SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_6.addChannel(y_channel = f'{self._dataReceiver}.ASIC5SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_7.addChannel(y_channel = f'{self._dataReceiver}.ASIC6SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
            self.ui.PyDMWaveformPlot_8.addChannel(y_channel = f'{self._dataReceiver}.ASIC7SigPed',x_channel = f'{self._dataReceiver}.IndexChannels',plot_style = "Line",color = "orange",lineWidth = 3)
